...
public class AcceptRejectFactoryTest {
  ...
  public final void testListAllSome(@Mocked final AcceptRejectDAO dao) {
    final AcceptReject mn = new AcceptReject(101, 1, 10, "Accepted");
    ...
    assertEquals(10, mn1[0].getVendorId());
  ...
  public final void testAcceptOrReject(@Mocked final AcceptRejectDAO dao) throws ParseException {
    final AcceptReject ac = new AcceptReject(101, 1, 10, "Accepted");
    new Expectations() {
        {
          dao.acceptedRejected(101, 1, 10, "Accepted");
        }
      };
    new MockUp<AcceptRejectFactory>() {
        @Mock
    ...
    int result1 = AcceptRejectFactory.acceptOrder(101, 1, 10, "Accepted");
